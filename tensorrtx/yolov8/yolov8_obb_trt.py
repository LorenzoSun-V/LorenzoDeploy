...
if __name__ == "__main__":
    ...
    engine_file_path = "/home/sysadmin/lorenzo/bt_repo/ultralytics/runs/hw_obb/model8_b32s-obb_20241114_cls2_hw_obb_v0.1/weights/best.engine"
    ...
    try:
        ...
        image_dir = "/data/bt/hw_obb/20241114/images/val/"
        ...
        #     print('start to process batch:', batch)
        #     thread1.start()
        #     thread1.join()
        for batch in image_path_batches:
            print(f"input: {batch}")
            batch_image_raw, use_time = yolov8_wrapper.infer(yolov8_wrapper.get_raw_image(batch))
            # batch_image_raw, use_time = self.image_path_batches.infer(self.yolov8_wrapper.get_raw_image(self.image_path_batch))
